...
DEMO_PANTRY: list[dict] = [
    _sku("Garam Masala", "g", 500, 80, brand="Everest", pack_size=100, pack_label="100 g carton", photo_url=_SPICE),
    _sku("Lal Mirch", "g", 400, 60, brand="MDH", pack_size=100, pack_label="100 g carton", photo_url=_CHILLI),
    _sku("Haldi", "g", 350, 50, brand="Everest", pack_size=100, pack_label="100 g carton", photo_url=_TURMERIC),
    _sku("Paneer", "g", 2000, 400, brand="Amul", pack_size=200, pack_label="200 g pouch", photo_url=_PANEER),
    _sku("Chicken", "g", 3000, 600, brand="Suguna", pack_size=1000, pack_label="1000 g tray", photo_url=_CHICKEN),
    _sku("Basmati Rice", "g", 5000, 800, brand="India Gate", pack_size=1000, pack_label="1000 g pack", photo_url=_RICE),
    _sku("Yogurt", "g", 1600, 400, brand="Amul", pack_size=400, pack_label="400 g cup", photo_url=_YOGURT),
    _sku("Butter", "g", 800, 150, brand="Amul", pack_size=100, pack_label="100 g brick", photo_url=_BUTTER),
    _sku("Tomato", "g", 2000, 400, brand="Farm Fresh", pack_size=500, pack_label="500 g crate", photo_url=_TOMATO),
    _sku("Potato", "g", 2500, 500, brand="Farm Fresh", pack_size=1000, pack_label="1000 g bag", photo_url=_POTATO),
    _sku("Wheat Flour", "g", 4000, 700, brand="Aashirvaad", pack_size=1000, pack_label="1000 g pack", photo_url=_FLOUR),
    _sku("Mango Pulp", "ml", 1700, 425, brand="Ratna", pack_size=850, pack_label="850 ml tin", photo_url=_MANGO),
    _sku("Khoya", "g", 600, 120, brand="Amul", pack_size=200, pack_label="200 g block", photo_url=_KHOYA),
    _sku("Mixed Vegetables", "g", 2000, 400, brand="Farm Fresh", pack_size=500, pack_label="500 g pack", photo_url=_VEG),
    _sku("Pav Bread", "pcs", 120, 24, brand="Wibs", pack_size=6, pack_label="6 pcs pack", photo_url=_BREAD),
    _sku("Spinach", "g", 1500, 250, brand="Farm Fresh", pack_size=250, pack_label="250 g bunch", photo_url=_SPINACH),
    _sku("Chickpeas", "g", 2500, 500, brand="Tata Sampann", pack_size=500, pack_label="500 g pack", photo_url=_CHICKPEA),
    _sku("Mutton", "g", 2500, 500, brand="Local Fresh", pack_size=1000, pack_label="1000 g tray", photo_url=_MUTTON),
    _sku("Apple", "g", 2000, 400, brand="Farm Fresh", pack_size=1000, pack_label="1000 g bag", photo_url=_APPLE),
    _sku("Tofu", "g", 1200, 200, brand="Morinaga", pack_size=200, pack_label="200 g block", photo_url=_TOFU),
    _sku("Eggs", "pcs", 120, 24, brand="Country Eggs", pack_size=12, pack_label="12 pcs tray", photo_url=_EGGS),
    _sku("Coffee Powder", "g", 400, 50, brand="Bru", pack_size=50, pack_label="50 g pouch", photo_url=_COFFEE),
    _sku("Tea Leaves", "g", 500, 80, brand="Tata Tea", pack_size=100, pack_label="100 g pack", photo_url=_TEA),
    _sku("Milk", "ml", 5000, 1000, brand="Mother Dairy", pack_size=500, pack_label="500 ml pouch", photo_url=_MILK),
    _sku("Onion", "g", 3000, 500, brand="Farm Fresh", pack_size=1000, pack_label="1000 g bag", photo_url=_ONION),
    _sku("Capsicum", "g", 1500, 300, brand="Farm Fresh", pack_size=500, pack_label="500 g pack", photo_url=_CAPSICUM),
    _sku("Lentils", "g", 2500, 500, brand="Tata Sampann", pack_size=500, pack_label="500 g pack", photo_url=_LENTIL),
    _sku("Cauliflower", "g", 1500, 300, brand="Farm Fresh", pack_size=500, pack_label="500 g head", photo_url=_CAULI),
    _sku("Cinnamon", "g", 200, 40, brand="Everest", pack_size=50, pack_label="50 g carton", photo_url=_CINNAMON),
    _sku("Sugar", "g", 4000, 700, brand="Madhur", pack_size=1000, pack_label="1000 g pack", photo_url=_SUGAR),
    _sku("Rice Flour", "g", 2500, 400, brand="Aashirvaad", pack_size=500, pack_label="500 g pack", photo_url=_RICE_FLOUR),
]
