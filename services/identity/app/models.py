...
class Owner(Base):
    ...
    live_photo_url: Mapped[str | None] = mapped_column(Text, nullable=True)
    live_photo_captured_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
