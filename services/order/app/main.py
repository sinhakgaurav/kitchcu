...
app = FastAPI(
    ...
    description=(
        ...
        "drafts, draft confirmation, order listing, CSV history export (F05), parse match-rate "
        "(F01), status lifecycle transitions, and ingredient stock-shortfall warnings (F19).\n"
