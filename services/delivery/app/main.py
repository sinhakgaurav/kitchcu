...
app = FastAPI(
    title="kitchCU Delivery Service",
    version="0.1.0",
    description="Delivery fees, distance quotes, tracking — Sprint 13",
    lifespan=lifespan,
)
...
async def health_ready() -> dict:
    ...
    if redis_client:
        try:
            ...
            redis_ok = False
    return await ready_response("delivery", database=db_ok, redis=redis_ok)
